...
### codex-v0.1 — Codex Compatibility Bridge

Minimal bridge release that makes PAI core architecture usable in Codex via generated `AGENTS.md`.

- Generates Codex-ready project instructions from PAI release metadata
- Reuses PAI algorithm and skill documentation without forcing Claude hooks
- Keeps existing Claude releases untouched

**[Get codex-v0.1 →](codex-v0.1/)**
